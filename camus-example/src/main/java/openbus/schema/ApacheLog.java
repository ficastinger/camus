...
public class ApacheLog extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static openbus.schema.ApacheLog.Builder newBuilder() {
    return new openbus.schema.ApacheLog.Builder();
  }
  
  /** Creates a new ApacheLog RecordBuilder by copying an existing Builder */
  public static openbus.schema.ApacheLog.Builder newBuilder(openbus.schema.ApacheLog.Builder other) {
    return new openbus.schema.ApacheLog.Builder(other);
  }
  
  /** Creates a new ApacheLog RecordBuilder by copying an existing ApacheLog instance */
  public static openbus.schema.ApacheLog.Builder newBuilder(openbus.schema.ApacheLog other) {
    return new openbus.schema.ApacheLog.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ApacheLog>
    ...
    private Builder() {
      super(openbus.schema.ApacheLog.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(openbus.schema.ApacheLog.Builder other) {
      super(other);
    ...
    private Builder(openbus.schema.ApacheLog other) {
            super(openbus.schema.ApacheLog.SCHEMA$);
      if (isValidValue(fields()[0], other.host)) {
        this.host = data().deepCopy(fields()[0].schema(), other.host);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'host' field */
    public openbus.schema.ApacheLog.Builder setHost(java.lang.CharSequence value) {
    ...
    public openbus.schema.ApacheLog.Builder clearHost() {
      host = null;
    ...
    /** Sets the value of the 'log' field */
    public openbus.schema.ApacheLog.Builder setLog(java.lang.CharSequence value) {
    ...
    public openbus.schema.ApacheLog.Builder clearLog() {
      log = null;
    ...
    /** Sets the value of the 'user' field */
    public openbus.schema.ApacheLog.Builder setUser(java.lang.CharSequence value) {
    ...
    public openbus.schema.ApacheLog.Builder clearUser() {
      user = null;
    ...
    /** Sets the value of the 'datetime' field */
    public openbus.schema.ApacheLog.Builder setDatetime(java.lang.CharSequence value) {
    ...
    public openbus.schema.ApacheLog.Builder clearDatetime() {
      datetime = null;
    ...
    /** Sets the value of the 'request' field */
    public openbus.schema.ApacheLog.Builder setRequest(java.lang.CharSequence value) {
    ...
    public openbus.schema.ApacheLog.Builder clearRequest() {
      request = null;
    ...
    /** Sets the value of the 'status' field */
    public openbus.schema.ApacheLog.Builder setStatus(java.lang.CharSequence value) {
    ...
    public openbus.schema.ApacheLog.Builder clearStatus() {
      status = null;
    ...
    /** Sets the value of the 'size' field */
    public openbus.schema.ApacheLog.Builder setSize(java.lang.CharSequence value) {
    ...
    public openbus.schema.ApacheLog.Builder clearSize() {
      size = null;
    ...
    /** Sets the value of the 'referer' field */
    public openbus.schema.ApacheLog.Builder setReferer(java.lang.CharSequence value) {
    ...
    public openbus.schema.ApacheLog.Builder clearReferer() {
      referer = null;
    ...
    /** Sets the value of the 'userAgent' field */
    public openbus.schema.ApacheLog.Builder setUserAgent(java.lang.CharSequence value) {
    ...
    public openbus.schema.ApacheLog.Builder clearUserAgent() {
      userAgent = null;
    ...
    /** Sets the value of the 'session' field */
    public openbus.schema.ApacheLog.Builder setSession(java.lang.CharSequence value) {
    ...
    public openbus.schema.ApacheLog.Builder clearSession() {
      session = null;
    ...
    /** Sets the value of the 'responseTime' field */
    public openbus.schema.ApacheLog.Builder setResponseTime(java.lang.CharSequence value) {
    ...
    public openbus.schema.ApacheLog.Builder clearResponseTime() {
      responseTime = null;
